...
namespace MKsEMS.Controllers
{
    public class LeavesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserEmail,ManagerEmail,DateFrom,DateTo,numberOfDays,LeaveType,Status,DenialReason")] Leave leave)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserEmail,ManagerEmail,DateFrom,DateTo,numberOfDays,LeaveType,Status,DenialReason")] Leave leave)
        {
            if (id != leave.Id)
            {
                return NotFound();
